 ...
 ?>
   ...
   <div class="sidebar close">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="floors.php" class="active"><i class='bx bx-building'></i><span class="link_name">Floors</span></a>
          <ul class="sub-menu blank">
    ...
    <div class="main_content">
      ...
      <section class="floor_admin_section">
        <div class="container">
          ...
          <div class="inner_con">
              ...
              <div class="d-flex justify-content-end align-items-end">
                <nav aria-label="Page navigation">
                  <ul class="pagination" id="pagination_links_floor">
                    <!--data-->
                  </ul>
                </nav>
              </div>
