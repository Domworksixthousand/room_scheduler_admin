...
// Kunin ang bilang per status per date
...
// I-prepare ang arrays para sa ApexCharts
$labels = [];
...
var options = {
    ...
    series: [
        { name: 'Done', data: <?php echo $js_done; ?>, color: '#00E396' },
        { name: 'Occupied', data: <?php echo $js_occupied; ?>, color: '#FFB100' },
        { name: 'Cancelled', data: <?php echo $js_cancelled; ?>, color: '#FF4560' }
    ],
    xaxis: {
