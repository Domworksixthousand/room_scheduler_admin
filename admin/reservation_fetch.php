...
if($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        if($end_date_data < $datetoday || $row['status'] === "Cancelled" || $row['status'] === "Done") {
        ...
        echo "<tr>
                ...
                <td>
                    <a href='reservation_cancel.php?booking_id={$row['booking_id']}' class='btn btn-danger btn-sm $hidden_func'>
    ...
    echo "<tr><td colspan='9' class='text-center py-4 text-muted'>No results found.</td></tr>";
}
...
$c_stmt->bind_param("sssss", $search_param, $search_param, $search_param, $search_param, $search_param);
$c_stmt->execute();
