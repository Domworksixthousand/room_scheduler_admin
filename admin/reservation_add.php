                        ...
                        <div class="inner_body shadow-lg">
                            ...
                            <div class="row mb-0" id="not_custom">
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="time" name="start_time" value="<?php echo $_SESSION['start_time_admin'] ?? ''; ?>"  class="form-control" required>
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <label for="end_time" class="form-label">End Time</label>
                                    <input type="time" value="<?php echo $_SESSION['end_time_admin'] ?? ''; ?>" name="end_time" class="form-control" required>
                                </div>
                            </div>
